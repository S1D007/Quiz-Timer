        ...
        if (optionInArrayOfQuestions === questionsFromBackend[queCount].correctAnswer) {
            ...
            switch (counter) {
                ...
                case 3:
                    ...
                    break;
                case 2:
                    presentToast(`Wrong Answer, '${2 * 2} points minus'`, "danger")
                    localStorage.setItem("coins",coins - 2 * 2)
                    break;
                case 1:
                    presentToast(`Wrong Answer, '${1 * 2} points minus'`, "danger")
                    localStorage.setItem("coins",coins - 1 * 2)
                    break;
                default:
            }
